...
async function getAdditionalInfo(artistsArray, baseUrl1, baseUrl2, myOptions, genre) {
	...
	artistsArray.forEach(function(artist) {
		if (additionalInfo[i].tracks.length > 2) {
			...
			//for(var f=0; f<3; f++){
			artist.popularSong = [
				additionalInfo[i].tracks[0].name,
				additionalInfo[i].tracks[1].name,
				additionalInfo[i].tracks[2].name,
			];
			artist.albumLink = [
				additionalInfo[i].tracks[0].album.external_urls.spotify,
				additionalInfo[i].tracks[1].album.external_urls.spotify,
				additionalInfo[i].tracks[2].album.external_urls.spotify,
			];
			artist.releaseDate = [
				additionalInfo[i].tracks[0].album.release_date,
				additionalInfo[i].tracks[1].album.release_date,
				additionalInfo[i].tracks[2].album.release_date,
			];
			artist.previewSong = [
				additionalInfo[i].tracks[0].preview_url,
				additionalInfo[i].tracks[1].preview_url,
				additionalInfo[i].tracks[2].preview_url,
			];
			artist.popularityOfSong = [
				additionalInfo[i].tracks[0].popularity,
				additionalInfo[i].tracks[1].popularity,
				additionalInfo[i].tracks[2].popularity,
			];
			artist.albumImage = [
				additionalInfo[i].tracks[0].album.images[smallImg1],
				additionalInfo[i].tracks[1].album.images[smallImg2],
				additionalInfo[i].tracks[2].album.images[smallImg3],
			];
			artist.albumName = [
				additionalInfo[i].tracks[0].album.name,
				additionalInfo[i].tracks[1].album.name,
				additionalInfo[i].tracks[2].album.name,
			];
			artist.albumType = [
				additionalInfo[i].tracks[0].album.album_type,
				additionalInfo[i].tracks[1].album.album_type,
				additionalInfo[i].tracks[2].album.album_type,
			];
			//}
		} else {
